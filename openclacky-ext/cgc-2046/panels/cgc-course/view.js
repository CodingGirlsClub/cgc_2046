...
// 学习的执行在 CGC 助手会话(侧栏「学习地图」面板承接);教研编辑拆出至
...
(() => {
  ...
  function materialMarkup(material) {
    ...
    return url ? '<a class="cglc-material cgch-mat-ref" href="' + escapeHtml(url) + '" target="_blank" rel="noopener noreferrer">' + title + '</a>' : '<span class="cgch-empty">材料来源无效</span>';
  }
