  ...
  return [
    ...
    },
    {
      ...
      blocks: [
        ...
        { kind: 'p', text: '「闪念间」历史档案删除：在线自助、即时生效——打开专属链接（或登录已绑定账号）即可在页面删除，无需注册：卡片从校友墙撤下、专属链接失效、当年答案与回信清除、许愿与许愿附议、留言及金句授权删除、触达记录去个人化。「闪念间」许愿内容（私有/公开）与留言：用于了解学员对活动与课程的期望、筹备后续活动；私有愿望仅本人与平台运营可见，公开愿望对学员可见可附议可留言；用户可自助删除；平台运营经管理通道（AI 助手辅助治理、审计留痕）可读取并对违规内容删除；随档案删除一并清除。触达退订：每封邮件页脚与短信内均含退订入口，退订后双通道（邮件/短信）均不再触达。' },
