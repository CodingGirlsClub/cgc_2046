...
export default defineConfig({
  ...
  test: {
    environment: 'node',
    include: ['tests/api-client.test.ts', 'tests/account-state.test.ts', 'tests/wish-draft-state.test.ts', 'tests/real-auth.test.ts', 'tests/real-content.test.ts', 'tests/initiative.test.ts', 'tests/campaign.test.ts', 'tests/volunteer-apply.test.ts', 'tests/enrollment-payment-status.test.ts', 'tests/error-codes.contract.test.ts', 'tests/real-moderation.test.ts'],
    clearMocks: true,
    restoreMocks: true
  }
})
