...
describe("常驻接入卡 OnboardingConnectCard（plan first-mile-onboarding U3，R8）", () => {
	it("邀请态（hasActiveCredential=false）：标题/说明 + 主 CTA 跳区入口页", () => {
		render(
			<OnboardingConnectCard slug="cgc-academy" hasActiveCredential={false} />,
		);
	...
	it("等待首联态（hasActiveCredential=true，AE5 前半）：提醒文案 + 指引链接，无主 CTA 文案", () => {
		render(<OnboardingConnectCard slug="cgc-academy" hasActiveCredential />);
