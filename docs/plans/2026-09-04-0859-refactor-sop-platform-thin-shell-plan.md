...
用户最新决定同时覆盖 R3/R13/KTD10/U2/DoD 的私有分支强制保护要求：保持免费套餐与仓库私有，采用人工 PR、自查或 review 后合并的约定，不升级、不将 GitHub 强制保护作为验收阻塞项。维护者可绕过人工约定属于接受的剩余风险；公开 main 与 production environment 的保护要求不变。
