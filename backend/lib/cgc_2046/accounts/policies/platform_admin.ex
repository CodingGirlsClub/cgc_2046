defmodule Cgc2046.Accounts.Policies.PlatformAdmin do
  @moduledoc """
  ...
  - **policy 面（本 check）**：跨租户治理读取放行。各资源 read policy 中的
    `authorize_if(Cgc2046.Accounts.Policies.PlatformAdmin)` 允许非成员平台管理员读取
  ...
  修改任一面前先读对面。能力面入口见 `Cgc2046.Accounts.Rbac.abilities_for/2`。
