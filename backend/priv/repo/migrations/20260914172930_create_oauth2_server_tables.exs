defmodule Cgc2046.Repo.Migrations.CreateOauth2ServerTables do
  @moduledoc """
  ...
  def down do
    ...
    drop_if_exists unique_index(:oauth_refresh_tokens, [:token_hash],
                     name: "oauth_refresh_tokens_by_token_hash_index"
                   )

    drop table(:oauth_refresh_tokens)

    drop_if_exists unique_index(:oauth_consents, [:user_id, :client_id],
                     name: "oauth_consents_by_user_client_index"
                   )
