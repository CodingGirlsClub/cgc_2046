defmodule Cgc2046.Mcp.WrapperGateTest do
  ...
  describe "派生门控集合 = 44 个豁免工具（精确名单）" do
    ...
    test "注册工具数 = 91 且名单完备（无未收录工具）" do
      meta_map = tool_meta_map()

      assert map_size(meta_map) == 91
