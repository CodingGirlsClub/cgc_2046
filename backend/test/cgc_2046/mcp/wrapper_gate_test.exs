defmodule Cgc2046.Mcp.WrapperGateTest do
  ...
  # 精确名单（与 server.ex 注册的 58 工具一一对应）
  ...
  @membership_deferred ~w(save_step_output get_course_content get_learning_records save_learning_records get_course_revision get_enrollment_summary create_enrollment get_order_status)
  ...
  describe "派生门控集合 = 20 个豁免工具（精确名单）" do
    ...
    test "membership: :deferred = save_step_output + 课程三学员侧工具 + 课程版本读 + 学员旅程三面" do
      meta_map = tool_meta_map()
